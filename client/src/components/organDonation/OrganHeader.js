        ...
        <Menu pointing secondary  >
          ...
          {!window.localStorage.getItem("isAuthenticated") ?
            <Menu.Menu position="right" style={{ marginRight: "40px" }}>
              ...
              <Menu.Item as={Nav} to="/organ-donation/donor-login" name="Donor Login" />
              <Menu.Item as={Nav} to="/organ-donation/donor-signup" name="Donor Sign Up" />
              <Menu.Item as={Nav} to="/organ-donation/hospital-login" name="Hospital Login" />
            </Menu.Menu>
            :
            <Menu.Menu position="right" style={{ marginRight: "40px" }}>
